...
export const metadata: Metadata = {
  title: "How to Make a Sticker on iPhone (3 Free Methods) | StickerSit",
  description:
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "How to Make a Sticker on iPhone - StickerSit",
      },
    ],
  },
  twitter: {
...
export default function HowToMakeStickerOnIphonePage() {
    ...
    step: [
      {
        "@type": "HowToStep",
        position: 1,
        name: "Open StickerSit on your iPhone",
  ...
  return (
    <main id="top" className="max-w-2xl mx-auto px-4 py-8">
      ...
      {/* Method 2: StickerSit (Hero Method) */}
      <section className="py-4">
        <div className="bg-gradient-to-r from-violet-50 to-purple-50 rounded-2xl p-6 shadow-sm border border-violet-100">
          ...
          <p className="text-sm text-gray-600 mb-6">
            Use StickerSit to create stickers from your imagination — no photo
      ...
      <section className="py-8">
        <div className="bg-white rounded-2xl p-6 shadow-sm">
          ...
          <div className="mt-4 bg-blue-50 rounded-xl p-3 text-xs text-blue-700">
            <strong>Tip:</strong> Combine methods! Use StickerSit to generate creative stickers from text, then import the downloaded PNGs into any of these apps to organize them into themed sticker packs.
          </div>
        </div>
      </section>
